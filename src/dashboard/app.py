...
if df_linhas.empty:
    ...
    if botao_buscar:
        ...
        col4.metric(
            label="🗺️ Itinerários", value=f"{len(sentidos_disponiveis)} sentido(s)"
        )
        ...
        with aba_trajeto:
            st.info(
                "⚡ **Próximo Milestone do Projeto:** Conectar dados de GPS em tempo real e cruzar as coordenadas com o PostgreSQL."
            )
