...
parametros = {"origin": "web", "v": "2", "project_id": "614", "route_id": "576935"}
...
try:
    ...
    if resposta.status_code == 200:
        ...
        with open(
            os.path.join(diretorio_atual, "resposta_real.json"), "w", encoding="utf-8"
        ) as f:
        ...
        print(
            f"❌ Erro na requisição! O servidor respondeu com Status: {resposta.status_code}"
        )
